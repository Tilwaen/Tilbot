exports.run = async (client, message, args, level, r, unbClient) => {
    ...
    message.reply(`https://www.reddit.com/api/v1/authorize?client_id=${client.config.redditAuth.clientID}&response_type=code&state=${usernameBase64}&redirect_uri=${client.config.defaultSettings.oauthRedirectUri}&duration=temporary&scope=identity`);
};
